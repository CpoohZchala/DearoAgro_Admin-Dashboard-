...
import {
  addProductFromHarvest,
  removeProductByHarvestId,
} from '../../api/productApi';
...
const StockDetails:
    ...
    try {
      ...
      if (
        ...
        if (
          ...
          const recordsWithCurrentAmount =
            data.map(
              (record) => {
                ...
                return {
                  ...
                  // If stock is zero,
                  // frontend treats it as not listed
                  isProductListed:
                    currentAmount > 0
                      ? Boolean(
        ...
        setError(
          response.message ||
          'Failed to fetch harvest records'
        );
  ...
  const handleDelete =
    ...
    const confirmed =
      window.confirm(
        `Are you sure you want to delete the harvest record for ${farmerName}?`
      );
  ...
  const handleToggleProduct =
    ...
    // -----------------------------------------------
    // DO NOT ALLOW ZERO STOCK TO BE LISTED
    // -----------------------------------------------
    ...
    if (
      ...
      alert(
        'Cannot list product with zero available stock'
      );
    ...
    try {
      ...
      // ---------------------------------------------
      // UPDATE STOCK LISTING STATUS
      // ---------------------------------------------

      const toggleResponse =
        await fetch(
          `/api/stocks/toggle/${recordId}`,
      ...
      if (
        ...
        throw new Error(
          'Failed to update stock listing status'
        );
      }
      ...
      if (
        ...
        await removeProductByHarvestId(
          recordId
        );
      ...
      // ---------------------------------------------
        ...
        if (
          ...
          throw new Error(
            'Missing required fields: name, price, or available quantity'
          );
        }
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <thead className="bg-green-50">
              ...
              <tr>
                ...
                <th className="px-6 py-3 text-center text-xs font-medium text-green-700 uppercase">
